...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "c68c7d46c9e53c7a")]
...
#pragma warning restore 0109
	...
	/// <summary>Protected Folder</summary>
	[PublishedContentModel("protectedFolder")]
	public partial class ProtectedFolder : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "protectedFolder";
		public new const PublishedItemType ModelItemType = PublishedItemType.Media;
#pragma warning restore 0109

		public ProtectedFolder(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<ProtectedFolder, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}

		///<summary>
		/// Member Groups: A commad delimited list of member groups - a member must be in at least one group to access media in this folder.
		///</summary>
		[ImplementPropertyType("memberGroups")]
		public string MemberGroups
		{
			get { return this.GetPropertyValue<string>("memberGroups"); }
		}
	}
